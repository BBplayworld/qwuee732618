<template>
    <div>
        ...
        <div>
            <div class="box">
                <div class="name font-opensans">VOO <span class="headline">[SeekingAlpha] AAII Sentiment Survey: Neutral
                        Sentiment Ticks Up</span></div>
                <div class="news-content"><!-- 추가된 부분: 이미지 썸네일 -->
                    <div class="thumbnail"><img
                            src="https://static.seekingalpha.com/cdn/s3/uploads/getty_images/1365097518/image_1365097518.jpg?io=getty-c-w1536"
                            alt="news thumbnail"></div>
                    <div class="value font-roboto">Analyzing recent changes in bullish, neutral, and
                        bearish sentiment in the market among investors. Click here to read my most recent analysis and
                        survey. <div class="url"><a
                                href="https://finnhub.io/api/news?id=0d49b26863690fa0887e77a3311fdd250d0de24688f9ee874433ff0592705861"
                                target="_blank">more</a></div>
                    </div>
                </div>
                <div class="date font-roboto">2024-09-27 01:33</div>
            </div>
        </div>
        <div>
            <div class="box">
        ...
        <div>
            <div class="box">
                ...
                <div class="date font-roboto">2024-09-26 16:06</div>
            </div>
        </div>
        <div>
            <div class="box">
